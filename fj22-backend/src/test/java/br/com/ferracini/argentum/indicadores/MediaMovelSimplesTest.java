...
class MediaMovelSimplesTest {
    ...
    void sequenciaSimplesDeCandles() {
        ...
        SerieTemporal serie = GeradorDeSerie.criaSerie(1, 2, 3, 4, 3, 5, 4, 3);
        ...
        BigDecimal ab = BigDecimal.valueOf(12.0).divide(BigDecimal.valueOf(3), RoundingMode.HALF_DOWN);
        ...
        assertAll("Verificando média simples",
                ...
                () -> assertEquals(BigDecimal.valueOf(12.0 / 3), mms.calcula(5, serie)),
